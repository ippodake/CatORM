package com.ippodakelabs.proxy.handlers;



import com.ippodakelabs.IppodakeORM;
import com.ippodakelabs.anotations.*;
...
public class DaoHandler implements InvocationHandler {
    ...
    private Object updateOne(Object proxy, Method method, Object[] args) throws Exception {
        ...
        Connection connection = IppodakeORM.getConnection();
